        ...
        <div className="lg:w-[20vw] lg:h-[100svh] rounded-[2vw] md:rounded-[.5vw] bg-gray-50 dark:bg-slate-800 p-[5vw] md:p-[2vw]">
          <aside>
            <div className="flex flex-col gap-[2vw] md:gap-[2vw]">
              ...
              >
                <option className="2xl:text-[.7vw]" value="default">All Categories</option>
                <option className="2xl:text-[.7vw]" value="smartphones">Smartphones</option>
                <option className="2xl:text-[.7vw]" value="headphones">Headphones</option>
                <option className="2xl:text-[.7vw]" value="laptops">Laptops</option>
                <option className="2xl:text-[.7vw]" value="watches">Watches</option>
              </select>
            </div>
          </aside>
        </div>
        ...
        <div className="flex flex-col gap-[5vw]">
          <div className="grid grid-flow-row grid-cols-1 md:grid-flow-row md:grid-cols-3 xl:grid-cols-3 gap-[5vw] md:gap-[2vw]">
            {paginatedProducts.map((product) => (
              ...
              >
                ...
                <div className="mx-[5vw] md:mx-[1vw] text-slate-800 dark:text-slate-100 font-semibold md:font-bold">
                  ...
                  <div className="my-[5vw] md:my-[1vw] text-slate-600 dark:text-slate-300 text-[3.8vw] md:text-[1.4vw]
            ...
            <div className="flex justify-center items-center w-full mt-4 gap-[4vw] lg:gap-[1vw]">
              <button className="text-slate-800 text-[6vw] md:text-[3vw] lg:text-[2vw]" onClick={handlePreviousPage} disabled={currentPage === 0}>
                <BsArrowLeftCircleFill/>
              </button>
              <span className="2xl:text-[1.4vw]">Page: {currentPage + 1} of {filteredProducts.length / 10}</span>
              <button className="text-primary text-[6vw] md:text-[3vw] lg:text-[2vw]"
